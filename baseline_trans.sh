...
cat outputs/"$basef"_src_sep | ~/marian-constraints/build/marian-decoder -v model/encs.spm model/encs.spm --no-spm-decode -m model/model_transformer_base_para_neg.npz.best-perplexity.npz  > outputs/"$basef"_translated.sp
