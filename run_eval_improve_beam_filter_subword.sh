...
do
   ...
   echo -n $prob, >> results/improve_beam_filter_subword.csv
	...
	python3 score_distance_suffix.py translated_improve_beam_filter_subword_$prob | tr "\n" "," >> results/improve_beam_filter_subword.csv 

	bash score_notconstrained_constrained_suffix.sh  translated_improve_beam_filter_subword_$prob |  tr "\n" "," >> results/improve_beam_filter_subword.csv 
    CUDA_VISIBLE_DEVICES=1  python score_comet.py 20 translated_improve_beam_filter_subword_$prob >> results/improve_beam_filter_subword.csv
